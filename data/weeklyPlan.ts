  ...
  weeks: [
    {
      ...
      tasks: [
        { day: "Mon", date: "Jun 22", activity: "Kick-off: AI Commerce enablement program — assign owners, cadence & goals", team: "Practice Head", type: "Internal Milestone", kpi: "Owners assigned / plan locked", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Tue", date: "Jun 23", activity: "Review commercetools Autonomous Commerce (MosAIc) reference architecture", team: "Practice", type: "Internal Milestone", kpi: "Architecture reviewed", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Wed", date: "Jun 24", activity: "Draft Royal Cyber Autonomous Commerce implementation blueprint", team: "Senior Architect", type: "Whitepaper", kpi: "Reference architecture drafted", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Thu", date: "Jun 25", activity: "AgenticLift architecture workshop: catalog, pricing, inventory, cart, order & CS context", team: "Practice", type: "Meeting", kpi: "Workshop completed", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Fri", date: "Jun 26", activity: "Publish AgenticLift POV + use-case map", team: "Senior Architect", type: "Internal Milestone", kpi: "POV + use-case map published", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Fri", date: "Jun 26", activity: "Define platform-agnostic Customer Service accelerator scope & adapter architecture", team: "Practice", type: "Internal Milestone", kpi: "CS accelerator scope & architecture defined", owner: "Vaibhav", department: "Practice", status: "todo" },
    ...
    },
    {
      ...
      tasks: [
        { day: "Mon", date: "Jun 29", activity: "Define sandbox / demo data approach and product-feed strategy", team: "Practice", type: "Internal Milestone", kpi: "Data approach defined", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Tue", date: "Jun 30", activity: "Draft Autonomous Commerce governance & data-readiness checklist", team: "Senior Architect", type: "Accelerator", kpi: "Setup checklist ready", owner: "Vaibhav", department: "Practice", status: "todo" },
        ...
        { day: "Thu", date: "Jul 02", activity: "Review demo script with Practice and align to MosAIc data feeds", team: "Practice", type: "Review", kpi: "Script reviewed", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Fri", date: "Jul 03", activity: "Finalise AgenticLift demo script and setup checklist", team: "Practice", type: "Internal Milestone", kpi: "Script + checklist signed off", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Fri", date: "Jul 03", activity: "Draft platform-agnostic CS accelerator adapter contracts (order, returns, ticketing, KB)", team: "Senior Architect", type: "Accelerator", kpi: "Adapter contracts drafted", owner: "Vaibhav", department: "Practice", status: "todo" },
    ...
    },
    {
      ...
      tasks: [
        { day: "Mon", date: "Jul 06", activity: "Build AgenticLift demo: AI-agent product discovery & inventory lookup", team: "Practice", type: "Accelerator", kpi: "Demo build started", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Tue", date: "Jul 07", activity: "Extend AgenticLift demo: pricing context & cart recommendation", team: "Practice", type: "Accelerator", kpi: "Demo functional end-to-end", owner: "Vaibhav", department: "Practice", status: "todo" },
        ...
        { day: "Thu", date: "Jul 09", activity: "Build Customer Service accelerator demo: order status, returns/refunds & KB answers via neutral adapters", team: "Practice", type: "Accelerator", kpi: "CS accelerator demo functional", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Fri", date: "Jul 10", activity: "Dry-run AgenticLift demo + workshop kit walkthrough", team: "Practice", type: "Review", kpi: "Dry-run completed", owner: "Vaibhav", department: "Practice", status: "todo" },
    ...
    },
    {
      ...
      tasks: [
        { day: "Mon", date: "Jul 13", activity: "Draft AI Commerce sales talk track for existing B2B/B2C customers needing AI readiness", team: "Sales + Practice", type: "Internal Milestone", kpi: "Talk track drafted", owner: "TBD", department: "Sales", status: "todo" },
        { day: "Tue", date: "Jul 14", activity: "Review talk track with Practice for technical accuracy", team: "Practice", type: "Review", kpi: "Talk track reviewed", owner: "Vaibhav", department: "Practice", status: "todo" },
        ...
        { day: "Fri", date: "Jul 17", activity: "Finalise sales talk track and industry AI commerce GTM pack", team: "Sales + Marketing", type: "Internal Milestone", kpi: "Talk track + GTM pack signed off", owner: "TBD", department: "Sales", status: "todo" },
    ...
    },
    {
      ...
      tasks: [
        { day: "Mon", date: "Jul 20", activity: "Prep partner review: finalise MosAIc / AgenticLift demo and POV deck", team: "Practice", type: "Internal Milestone", kpi: "Review pack ready", owner: "Vaibhav", department: "Practice", status: "todo" },
        { day: "Wed", date: "Jul 22", activity: "Partner review with commercetools team — walk through MosAIc / AgenticLift demo", team: "Partnerships", type: "Meeting", kpi: "Meeting completed", owner: "Vaibhav", department: "Partnerships", status: "todo" },
        { day: "Thu", date: "Jul 23", activity: "Capture co-sell feedback and log partner action items", team: "Partnerships", type: "Review", kpi: "Feedback captured", owner: "Vaibhav", department: "Partnerships", status: "todo" },
        { day: "Thu", date: "Jul 23", activity: "Review platform-agnostic Customer Service accelerator with commercetools partner team", team: "Partnerships", type: "Meeting", kpi: "CS accelerator feedback captured", owner: "Vaibhav", department: "Partnerships", status: "todo" },
        { day: "Fri", date: "Jul 24", activity: "Update POV into a partner-ready POV with co-sell positioning", team: "Practice", type: "Whitepaper", kpi: "Partner-ready POV published", owner: "Vaibhav", department: "Practice", status: "todo" },
    ...
    },
    {
      ...
      tasks: [
        ...
        { day: "Wed", date: "Jul 29", activity: "Run AI-led modernization validation workshop with prospects", team: "Sales", type: "Meeting", kpi: "Workshop delivered", owner: "TBD", department: "Sales", status: "todo" },
        { day: "Wed", date: "Jul 29", activity: "Showcase platform-agnostic Customer Service accelerator in modernization workshops", team: "Sales + Practice", type: "Meeting", kpi: "CS accelerator demoed to prospects", owner: "TBD", department: "Sales", status: "todo" },
        { day: "Thu", date: "Jul 30", activity: "Qualify opportunities and capture AI-readiness scores", team: "Sales", type: "Internal Milestone", kpi: "Qualified AI-led opportunities logged", owner: "TBD", department: "Sales", status: "todo" },
