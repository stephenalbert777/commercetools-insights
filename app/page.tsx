      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        >
          ...
          <h2 className="mt-2 text-2xl font-bold text-rc-blue">
            commercetools Weekly Plan
          </h2>
          <p className="mt-3 text-sm text-[#5a6b82]">
            A {weeklyPlan.weeks.length}-week execution plan covering Sphere,
            AgenticLift, the Commerce MCP, migrations and Checkout — broken into
            team focus areas, day-by-day tasks with owners, and a RACI matrix.
          </p>
